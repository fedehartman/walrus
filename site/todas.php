...
<head>
	...
	<title>Todas las Ofertas | Woow!</title>

	<meta name="description" content="Todas las Ofertas | Woow!" />
...
<section id="listados">
	...
	<header class="sombra">
		...
		<div class="buscador">
			<form id="listado-search">
				<fieldset>
					<div class="left">
						<input type="search" class="form_search" placeholder="Buscar&hellip;">
					</div>
					<div class="left">
						<select>
	...
	<div id="paginacion-wrapper" class="sombra">
		<figure></figure>
		<div class="contenido">
			...
			<p>Más Ofertas</p>
		</div> <!--"paginacion-contenido"-->
	</div> <!--"paginacion-wrapper"-->
