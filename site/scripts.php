	...
	<script src="js/libs/modernizr.custom.41609.js"></script>
	<script src="js/libs/bootstrap/bootstrap.min.js"></script>

	<script src="js/plugins.js"></script>
	<script src="js/script.js"></script>

	<script src="js/libs/queryloader2.js"></script>
	...
	<script src="js/libs/oferta_slider/jquery.elastislide.js"></script>